...
if __name__ == "__main__":
    ...
    with tf.device('/gpu:0'):  # Use '/gpu:0' if TensorFlow-Metal is installed
        ...
        train_input_tensors_augmented = np.concatenate((train_input_tensors, additional_train_input_tensors), axis=0)
        ...
        history = train_model(model, train_input_tensors_augmented, train_depth_tensors_augmented, val_input_tensors, val_depth_tensors, epochs=10, batch_size=32)
